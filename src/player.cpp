...
void Player::Move(bool moveUp, double deltaTime) {
	if (moveUp) {
...
void Player::Update(double deltaTime, std::vector<Renderable*>& renderables) {
...
void Player::Fire(std::vector<Renderable*>& renderables) {
	if (bulletCooldown <= 0.0) {
